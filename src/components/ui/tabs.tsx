  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className="px-4 py-1.5 rounded-full text-sm font-semibold border transition-colors
        data-[state=active]:bg-gray-900 data-[state=active]:dark:bg-white data-[state=active]:text-white data-[state=active]:dark:text-gray-900 data-[state=active]:border-gray-900 data-[state=active]:dark:border-white
